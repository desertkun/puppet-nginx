...
describe 'nginx::config' do
  context 'with defaults' do
    ...
    context 'when confd_purge false' do
      ...
      it do
        is_expected.to contain_file('/etc/nginx/conf.d').without(%w(
                                                                   ignore
                                                                   purge
                                                                   recurse
                                                                 ))
    ...
    context 'when vhost_purge false' do
      ...
      it do
        is_expected.to contain_file('/etc/nginx/sites-available').without(%w(
                                                                            ignore
                                                                            purge
                                                                            recurse
                                                                          ))
      ...
      it do
        is_expected.to contain_file('/etc/nginx/sites-enabled').without(%w(
                                                                          ignore
                                                                          purge
                                                                          recurse
                                                                        ))
      ...
      it do
        is_expected.to contain_file('/var/log/nginx').without(%w(
                                                                ignore
                                                                purge
                                                                recurse
                                                              ))
